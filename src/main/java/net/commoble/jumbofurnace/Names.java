...
public class Names
{
	...
	public static final String TAG_STACK = "tag_stack";
	
	public static final String ASSEMBLE_JUMBO_FURNACE = "assemble_jumbo_furnace";
	public static final String UPGRADE_JUMBO_FURNACE = "upgrade_jumbo_furnace";
}
